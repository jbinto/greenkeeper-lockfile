...
module.exports.getGitUser = function setupGitUser () {
  ...
  return { commitEmail, commitName }
}

module.exports.setupGitUser = function setupGitUser () {
  const { commitEmail, commitName } = module.exports.getGitUser()
...
module.exports.commitLockfiles = function commitLockfiles () {
  ...
  if (shouldAmend) {
    ...
    const updateMessage = `chore(package): update ${lockfileWording} [ci skip]`
